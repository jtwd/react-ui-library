  ...
  return (
    <div>
      <HBox pack="start" className="docs-eg-height">
        <Wrapper middle className="docs-example docs-ele1">Item 1</Wrapper>
        <Wrapper middle className="docs-example docs-ele2">Item 2</Wrapper>
        <Wrapper middle className="docs-example docs-ele3">Item 3</Wrapper>
      </HBox>
