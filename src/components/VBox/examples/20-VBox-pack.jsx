  ...
  return (
    <div>
      <VBox pack="start" className="docs-eg-height3">
        <Wrapper collapse middle className="docs-example docs-ele1">Item 1</Wrapper>
        <Wrapper collapse middle className="docs-example docs-ele2">Item 2</Wrapper>
        <Wrapper collapse middle className="docs-example docs-ele3">Item 3</Wrapper>
      </VBox>
